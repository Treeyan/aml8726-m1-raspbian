...
#define WRITE_CBUS_REG(reg, val) __raw_writel(val, (void*)CBUS_REG_ADDR(reg))
#define READ_CBUS_REG(reg) (__raw_readl((void*)CBUS_REG_ADDR(reg)))
...
#define READ_CBUS_REG_BITS(reg, start, len) \
    ((READ_CBUS_REG(reg) >> (start)) & (((32==(len))? 0 : (1L<<(len)))-1))
...
#define WRITE_AHB_REG(reg, val) __raw_writel(val, (void*)AHB_REG_ADDR(reg))
#define READ_AHB_REG(reg) (__raw_readl((void*)AHB_REG_ADDR(reg)))
...
#define WRITE_APB_REG(reg, val) __raw_writel(val, (void*)APB_REG_ADDR(reg))
#define READ_APB_REG(reg) (__raw_readl((void*)APB_REG_ADDR(reg)))
