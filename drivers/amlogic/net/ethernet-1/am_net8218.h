...
#define IO_WRITE32(val,addr)	    __raw_writel(val,(void*)(addr))
#define IO_READ32(addr)	 	        __raw_readl ((void*)(addr))
#define ETHBASE (IO_ETH_BASE)
#define WRITE_PERIPHS_REG(v,addr)   __raw_writel(v,(void*)(addr))
#define READ_PERIPHS_REG(addr)      __raw_readl ((void*)(addr))
